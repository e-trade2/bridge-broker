...
const SUPABASE_KEY  = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhybWJ6eWNhc2J6ZGFvbHZ0dW9wIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODE4MDQ1MzksImV4cCI6MjA5NzM4MDUzOX0.B6Jqf5Pv0C4AkAu-BaYy0TeS6xXajRGvm31pKGVYYn0';
...
export async function sendPasswordReset(email) {
  const { error } = await supabase.auth.resetPasswordForEmail(email, {
    redirectTo: 'https://e-trade2.github.io/bridge-broker/seller-dashboard.html',
  });
  if (error) throw error;
}
